package com.niannian99.appweb.controller;
...
import com.niannian99.appweb.utils.HttpUtil;
...
//    @Value("${wechat.appSecret}")
    private String appSecret="xxxxx";
...
//    @Value("${wechat.url.apiTicket}")
    ...
    //获取微信参数
    @RequestMapping(value = "/wechatParam", method = {RequestMethod.POST, RequestMethod.GET})
	@ResponseBody
